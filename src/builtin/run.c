...
/*   Updated: 2025/01/08 21:10:52 by glima            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/minishell.h"

static bool	return_bool(bool is_builtin, char **argv, \
t_shellzin *shell, size_t	len)
{
...
bool	shellzin_try_run_builtin(char **argv, t_shellzin *shell)
{
	...
	if (len <= 1)
		return (false);
	if (return_bool(is_builtin, argv, shell, len))
		is_builtin = true;
